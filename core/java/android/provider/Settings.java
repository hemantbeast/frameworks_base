    ...
    public static final class System extends NameValueTable {
        ...
        */
        ...
        static {
            ...
            PRIVATE_SETTINGS.add(KEYBOARD_BRIGHTNESS);
            ...
            PRIVATE_SETTINGS.add(KEY_HOME_LONG_PRESS_CUSTOM_APP);
            PRIVATE_SETTINGS.add(KEY_HOME_LONG_PRESS_CUSTOM_APP_FR_NAME);
            PRIVATE_SETTINGS.add(KEY_HOME_DOUBLE_TAP_ACTION);
            PRIVATE_SETTINGS.add(KEY_HOME_DOUBLE_TAP_CUSTOM_APP);
            PRIVATE_SETTINGS.add(KEY_HOME_DOUBLE_TAP_CUSTOM_APP_FR_NAME);
            ...
            PRIVATE_SETTINGS.add(KEY_BACK_LONG_PRESS_CUSTOM_APP);
            PRIVATE_SETTINGS.add(KEY_BACK_LONG_PRESS_CUSTOM_APP_FR_NAME);
            PRIVATE_SETTINGS.add(KEY_BACK_DOUBLE_TAP_ACTION);
            PRIVATE_SETTINGS.add(KEY_BACK_DOUBLE_TAP_CUSTOM_APP);
            PRIVATE_SETTINGS.add(KEY_BACK_DOUBLE_TAP_CUSTOM_APP_FR_NAME);
            ...
            PRIVATE_SETTINGS.add(KEY_APP_SWITCH_LONG_PRESS_CUSTOM_APP);
            PRIVATE_SETTINGS.add(KEY_APP_SWITCH_LONG_PRESS_CUSTOM_APP_FR_NAME);
            PRIVATE_SETTINGS.add(KEY_APP_SWITCH_DOUBLE_TAP_ACTION);
            PRIVATE_SETTINGS.add(KEY_APP_SWITCH_DOUBLE_TAP_CUSTOM_APP);
            PRIVATE_SETTINGS.add(KEY_APP_SWITCH_DOUBLE_TAP_CUSTOM_APP_FR_NAME);
            ...
            PRIVATE_SETTINGS.add(LONG_BACK_SWIPE_TIMEOUT);
