...
public class SystemSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(System.QS_SMART_PULLDOWN, new InclusiveIntegerRangeValidator(0, 3));
        ...
        VALIDATORS.put(System.STATUS_BAR_BATTERY_STYLE, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(System.STATUS_BAR_SHOW_BATTERY_PERCENT, ANY_INTEGER_VALIDATOR);
        ...
        VALIDATORS.put(System.SECONDARY_COLOR_CLOCK, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(System.OMNI_BUTTON_EXTRA_KEY_MAPPING, BOOLEAN_VALIDATOR);
