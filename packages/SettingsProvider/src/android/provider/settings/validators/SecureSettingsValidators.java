...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.FP_SWIPE_TO_DISMISS_NOTIFICATIONS, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.QS_FOOTER_SHOW_SETTINGS, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.QS_FOOTER_SHOW_SERVICES, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.QS_FOOTER_SHOW_EDIT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.QS_FOOTER_SHOW_USER, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.QS_FOOTER_SHOW_POWER_MENU, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.QS_TILES_VIBRATE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.BACK_GESTURE_HEIGHT, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.SHOW_BACK_ARROW_GESTURE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.GESTURE_HANDLE_HIDE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.VOLUME_PANEL_ON_LEFT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.SHOW_CPU_OVERLAY, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.SHOW_FPS_OVERLAY, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.HARDWARE_KEYS_DISABLE, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(Secure.LOCK_QS_DISABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.STATUSBAR_CLOCK_SECONDS, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.STATUS_BAR_CLOCK, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.STATUSBAR_CLOCK_POSITION, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.STATUSBAR_CLOCK_AM_PM_STYLE, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.STATUSBAR_CLOCK_DATE_DISPLAY, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.STATUSBAR_CLOCK_DATE_STYLE, ANY_INTEGER_VALIDATOR);
        ...
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_DURATION, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_COLOR_MODE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_REPEAT_COUNT, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_REPEAT_DIRECTION, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_WIDTH, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.KEYGUARD_TRANSITION_ANIMATIONS, BOOLEAN_VALIDATOR);
    }
}
